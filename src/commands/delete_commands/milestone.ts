...
export const describe = 'delete a milestone with the supplied title\n\nby default this will delete the milestone across Dojo 2 repos';

export const builder: CommandBuilder = function (yargs) {
	return yargs
		.example('$0 delete milestone foo', 'deletes a milestone with the title of "foo" across Dojo 2 repos');
};
